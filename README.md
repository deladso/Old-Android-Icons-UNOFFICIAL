# Old-Android-Icons-UNOFFICIAL
an unofficial fork from a Android ICS Icon Pack from r/OldAndroid1.

# ⚠️WARNING

**Installing this one will also replace/update your current Alchemicons Icon Pack installed. Will be changed in future updates.** 
...
# ⭐If you like this icon pack,feel free to star it.

And if you have any app requests,you can request them in the 'Issues' tab.